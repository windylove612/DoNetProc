...
namespace WhatYouWant
{
    public static class AsPoseHelper
    {
        ...
        public static DataTable ExcelToDataTable(string fileName, string sheetName, bool isFirstRowColumnName, bool isNeedFirstRow)
        {
            ...
            try
            {
                ...
                if (workbook != null)
                {
                    ...
                    if (worksheet != null)
                    {
                        ...
                        {
                            data = worksheet.Cells.ExportDataTable(1, 0, worksheet.Cells.MaxRow + 1, worksheet.Cells.MaxColumn + 1,
                            isFirstRowColumnName);
                        }
